...
class Orderdetails(models.Model):
    ordernumber = models.ForeignKey('Orders', models.DO_NOTHING, db_column='orderNumber', unique=True)  # Field name made lowercase.
...
class Payments(models.Model):
    customernumber = models.ForeignKey(Customers, models.DO_NOTHING, db_column='customerNumber', unique=True)  # Field name made lowercase.
...
class Productlines(models.Model):
    product_line = models.CharField(db_column='product_line', primary_key=True, max_length=50)  # Field name made lowercase.
    text_desc = models.CharField(db_column='text_desc', max_length=4000, blank=True, null=True)  # Field name made lowercase.
    html_desc = models.TextField(db_column='html_desc', blank=True, null=True)  # Field name made lowercase.
